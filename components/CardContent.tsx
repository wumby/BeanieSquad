        ...
        <div className="flex justify-center flex-wrap z-10">
          <Lens hovering={hovering} setHovering={setHovering}>
            <Image
              ...
              alt={`${props.player.name} skipped media day`}
              width={300}
              height={300}
              className="rounded-2xl !h-[100px] !w-[100px] lg:!h-[250px] lg:!w-[250px]"
            />
          </Lens>
          <motion.div
            animate={{
          ...
          >
            ...
            <h2 className="text-white text-md lg:text-2xl text-left font-bold flex justify-center w-full mb-2">
              <span className="pr-4">{props.player.height}</span>
            ...
            <div className=" w-[100%] md:w-[75%]">
              <CardBorder
                className="rounded-[22px] bg-black"
                rarity={props.player.rarity}
              >
                <h1 className="flex justify-center text-sm sm:text-md lg:text-2xl text-white">
                  {props.player.archetype}
                </h1>
              </CardBorder>
            </div>
          </motion.div>
